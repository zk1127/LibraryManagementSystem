...
<body>
  ...
  <div class="col-sm-3 col-md-2 sidebar">
    ...
    <ul class="nav nav-sidebar">
      <li><a href="search_forfeit.php">
        <?php echo $bookAdmin_left_nav3_1; ?></a></li>
        <li class="active"><a href="insert_forfeit.php">
      ...
      <div class="container">
        <h1>Insert forfeit</h1>  
        <form class="form-horizontal" role="form" action="insert_forfeit2.php" name="form" method="post" enctype="multipart/form-data">
