...
<body>
  ...
  <div class="container">
    ...
    <form class="form-horizontal" role="form" action="insert_book_api2.php" name="form" method="post">
      <div class="form-group">
        <label class="col-sm-2 control-label">Please input ISBN</label>
        <div class="col-sm-4">
          <input class="form-control" type="text" name="ISBN" placeholder="ISBN" autofocus="autofocus">
        </div>
      </div>

      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <input type="submit" name="submit" class="btn btn-primary" value="Check Its Information" />
        </div>
      </div>
