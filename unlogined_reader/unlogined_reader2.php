...
<body>
	...
	<div class="col-sm-3 col-md-2 sidebar">
		<ul class="nav nav-sidebar">
			<li class="active"><a href="unlogined_reader.php">Search <span class="sr-only current"></span></a></li>
			<li><a href="unlogined_books.php">Display all</a></li>
		</ul>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-offset-3 col-sm-7">
				<form action="unlogined_reader2.php" method="post">
    ...
    //echo $sql;  
				...
				if($link){  
					...
					if(!$resoures){  
						...
						echo "<Script>window.location.href='unlogined_reader.php'</Script>";  
					}  
