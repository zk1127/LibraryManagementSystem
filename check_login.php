...
//检查登录信息
    ...
    function selectNext($r){  
    	if($r == 0){    
           ...
           echo "<Script>alert('adminster is not exist');</Script>";  
           echo "<Script>window.location.href='login.html'</Script>";  
         }else if ($r == 3){  
           $_SESSION['user'] = $_POST['user'];
       //将登录名保存到session中
           echo "<Script>alert('Login successfully');</Script>"; 
           echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=logined_reader.php">';
         ...
         $_SESSION['user'] = $_POST['user'];
         echo "<Script>alert('Login successfully');</Script>";   
         echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=bookAdmin/logined_bookAdmin.php">'; 
       }    
     }  
