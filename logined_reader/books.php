				...
				<table class="table table-striped">
					...
					<tbody>
						...
						while($row = mysql_fetch_array($result))
						{
							...
							echo "<tr>";					
							echo "<td style='display:none'><input type='text' name='book_Name' style='visibility:hidden' value='" . $row['name'] . "'/></td>";
							echo "<td>" . $row['name'] . "</td>";
							echo "<td>" . $row['cb'] . "</td>";
							echo "<td>" . $row['isbn'] . "</td>";
							echo "<td>" . $row['atr'] . "</td>";
							...
							if(strpos($row['pci'],'ps')!=false){
								echo "<td><img width=100px height=125px src='" . $row['pci'] . "'/></td>";
